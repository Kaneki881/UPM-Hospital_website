...
<div class="container-fluid">
    ...
    <thead>
        <tr>
            <th>Schedule</th>
            <th>Doctor</th>
            <th>Patient</th> <!-- Updated column header -->
            <th>Status</th>
            <th>Action</th>
        </tr>
    </thead>
    ...
    <tr>
        ...
        <td>
            <?php
            $patient_id = $row['patient_id']; // Get the patient_id from the appointment record
            $patient_name = isset($p_arr[$patient_id]['name']) ? $p_arr[$patient_id]['name'] : 'Patient Not Found';
            echo $patient_name;
            ?>
        </td>
        <td>
